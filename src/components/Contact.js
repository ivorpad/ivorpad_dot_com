    ...
    return (
      <div className="container flex px-4 justify-center">
        <div className="form-container w-1/2">
          ...
          <p className="ml-8 pb-8 text-grey-dark leading-normal text-justify text-lg -mt-3 pr-8">If you have any inquiries feel free to drop me a line. You can request a quote for your project or just say hi!</p>
