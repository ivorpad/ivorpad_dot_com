...
export default class HomePage extends Component {
  ...
  render() {
    return (
      <main className="homepage-content container pt-8 pb-8 mx-auto w-4/5 px-4 lg:w-3/4 md:w-3/4 xl:w-2/5 md:pt-0 lg:pt-0 xl-pt-0 md:pb-0 lg:pb-0 xl:pb-0">
        <div className="flex flex-col main--section">
          ...
          <Tooltip title="(eye-vor || /ʌɪˈvɔːr/)" position="top" trigger="mouseenter" animation="fade" arrow={true} >
              <span className="border-b border-blue-dark border-dotted">Ivor</span>
            </Tooltip>
          </h1>
